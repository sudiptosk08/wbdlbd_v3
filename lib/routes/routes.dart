...
import 'package:loan_app/app/navigation/binding/navigation_binding.dart';
...
class Routes {
  ...
  static var list = [
    ...
    GetPage(
        name: installmentRecordsPage,
        page: () => const InstallmentRecordsPage(),
        binding: InstallmentRecordsBinding(),
        arguments: "index"),
    GetPage(
      name: withdrawPage,
