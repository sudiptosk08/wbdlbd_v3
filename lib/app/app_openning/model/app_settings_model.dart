...
class Lang {
  ...
  final String bkashAccount;
  final String nagodAccount;
  final String submitScreenshotsOfAllFeeTransfers;
  final String rechargeHistory;
  final String pickImageFromGallery;
  final String worldBankDevelopment;
  ...
  final String installmentRecord;
  final String areYouSureWantToPayThisInstallment;
  final String confirm;
  final String cancel;
  final String youAreNotEligiableForLoanRequest;
  final String paid;
  ...
  Lang({
    ...
    required this.bkashAccount,
    required this.nagodAccount,
    required this.submitScreenshotsOfAllFeeTransfers,
    required this.rechargeHistory,
    required this.pickImageFromGallery,
    required this.worldBankDevelopment,
    ...
    required this.installmentRecord,
    required this.areYouSureWantToPayThisInstallment,
    required this.confirm,
    required this.cancel,
    required this.youAreNotEligiableForLoanRequest,
    required this.paid,
  });
  ...
  factory Lang.fromJson(Map<String, dynamic> json) => Lang(
        ...
        bkashAccount: json["bkashAccount"],
        nagodAccount: json["nagodAccount"],
        submitScreenshotsOfAllFeeTransfers:
            json["submitScreenshotsOfAllFeeTransfers"],
        rechargeHistory: json["rechargeHistory"],
        pickImageFromGallery: json["pickImageFromGallery"],
        worldBankDevelopment: json["worldBankDevelopment"],
        appLanguage: json["appLanguage"],
        completed: json["completed"],
        due: json["due"],
        installments: json["installments"],
        totalAmount: json["totalAmount"],
        perInstallment: json["perInstallment"],
        pay: json["pay"],
        billNo: json["billNo"],
        lastDate: json["lastDate"],
        installmentRecord: json["installmentRecord"],
        areYouSureWantToPayThisInstallment:
            json["areYouSureWantToPayThisInstallment"],
        confirm: json["confirm"],
        cancel: json["cancel"],
        youAreNotEligiableForLoanRequest:
            json["youAreNotEligiableForLoanRequest"],
        paid: json["paid"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "bkashAccount": bkashAccount,
        "nagodAccount": nagodAccount,
        "submitScreenshotsOfAllFeeTransfers":
            submitScreenshotsOfAllFeeTransfers,
        "rechargeHistory": rechargeHistory,
        "pickImageFromGallery": pickImageFromGallery,
        "worldBankDevelopment": worldBankDevelopment,
        ...
        "confirm": confirm,
        "cancel": cancel,
        "youAreNotEligiableForLoanRequest": youAreNotEligiableForLoanRequest,
        "paid": paid,
      };
}
