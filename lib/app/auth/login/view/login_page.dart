                ...
                children: [
                  ClipPath(
                    ...
                    child: Container(
                        ...
                        color: KColors.primary, // Set the background color of your container
                        child: Column(
                          children: [
                            Padding(
                              padding: const EdgeInsets.only(left: 55.0, right: 55.0, bottom: 0, top: 40),
                              child: Image.asset(
                                "asset/world.png",
                                color: KColors.white,
                                width: 40.w,
                            ...
                            Text(
                              ...
                              style: TextStyle(fontSize: 24.sp, color: KColors.white, fontWeight: FontWeight.bold, fontFamily: KFontFamily.poppins),
                            ),
                            Text(
                              "Micro Finance",
                              style: TextStyle(fontSize: KFontSize.large, color: KColors.white, fontWeight: FontWeight.bold, fontFamily: KFontFamily.poppins),
                            ),
                          ],
                        )),
                  ),
                      ...
                      children: [
                                        ...
                                        Expanded(
                                          ...
                                          () => ListView.separated(
                                            ...
                                            itemBuilder: (context, index) {
                                              return ListTile(
                                                onTap: () {
                                                  controller.country.value = controller.countries[index];
                                                  Get.back();
                                                },
                                                title: Text(
                                                ...
                                                trailing: Text(
                                                  controller.countries[index].phoneCode,
                                                  style: TextStyle(
                        ...
                        TextFieldContainer(
                          ...
                          suffixIcon: IconButton(
                            onPressed: () {
                              controller.isObscureLoginPass.value = !controller.isObscureLoginPass.value;
                            },
...
class MyClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.quadraticBezierTo(size.width * 0.5, size.height - 70, size.width, size.height);
